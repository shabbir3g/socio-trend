            ...
            <div className="container m-5 rounded bg-white  mx-auto">
                ...
                {/* header-icon-section */}
                    <div className="flex justify-between">
                        <div className="">
                            <h3 className="text-2xl font-bold">Notification <span className="bg-orange-600 m-0  px-4 py-1 rounded font-normal text-white text-base">23</span></h3>
                        </div>
                        <div className="flex gap-6">
                                 <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9 bg-gray-100 p-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     ...
                     <div style={{height:'50px'}}  className="relative">
                        <Image
                           className=""
                            ...
                            alt="img"
                        />
                        <span className="bg-orange-600 m-0  font-normal text-white text-base rounded-full h-7 w-7 absolute bottom-0 right-0 p-1">23</span>
                    </div>
                        <div className="pl-5">
                            <p className="font-sans font-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel rem reiciendis veritatis culpa officiis non blanditiis consectetur odit! Quia, facilis!</p>
