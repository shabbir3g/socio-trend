...
const Register = () => {
  ...
  return (
    <section className="grid lg:grid-cols-5 grid-cols-2 min-h-screen">
      {errorMsg && toast(errorMsg)}
      <div className="hidden lg:flex col-span-2 bg-gradient-to-br from-green-200 via-green-300 to-blue-500">
        <div className="flex flex-col justify-start items-start py-10 pl-16">
          ...
          <h1 className="text-white font-bold text-2xl tracking-wider pl-4">
        ...
        <div className="mt-8 mx-auto w-full max-w-md">
          ...
          <div className="rounded-lg px-4">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                <label htmlFor="email" className="block text-lg text-gray-900 dark:text-white">
