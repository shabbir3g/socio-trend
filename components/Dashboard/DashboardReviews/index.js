...
const Reviews = () => {
  const [isNewReviewsPopupOpen, setIsNewReviewsPopupOpen] = useState(false);
  const closeNewReviewsPopup = () => setIsNewReviewsPopupOpen(false);
  const openNewReviewsPopup = () => setIsNewReviewsPopupOpen(true);
  return (
    <>
      <AddReviewsPopup
        isNewReviewsPopupOpen={isNewReviewsPopupOpen}
        closeNewReviewsPopup={closeNewReviewsPopup}
      />
      <section className="py-6 px-4 sm:px-6 lg:py-10 lg:px-8">
        <div className="pb-5 flex items-center ">
          <h3 className="text-4xl leading-6 font-medium text-slate-100">
            Reviews
          </h3>
          <div className="ml-4">
            <button
              onClick={openNewReviewsPopup}
        ...
        {/* nav */}
        <div className="block no-scrollbar overflow-x-scroll border-b border-slate-800">
          <nav className="pl-2 flex space-x-6">
            <a
              href="#"
              className="border-transparent text-slate-400 hover:text-slate-200 hover:border-slate-200 whitespace-nowrap flex py-3 px-1 border-b-2 font-medium text-sm"
            >
              All
            ...
            <a
              href="#"
              className="border-teal-400 text-teal-400 whitespace-nowrap flex py-3 px-1 border-b-2 font-medium text-sm"
              aria-current="page"
            >
              Approved
              <span className="bg-slate-800 text-teal-500 ml-2 py-0.5 px-2.5 rounded-full text-xs font-medium">
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div>
                            <div
                              title=" Regional Paradigm Technician Paradigm Technician"
                              className="text-sm font-medium w-72 truncate text-slate-200"
                            >
