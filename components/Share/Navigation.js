...
const Navigation = () => {
    return (
        ...
        <div className='flex items-center bg-white'>
            <a href='#' className='font-bold text-4xl py-6 text-blue-700 pl-10 pr-16'>Socio Trend.</a>
            ...
            <div className='flex ml-auto'>
                ...
                <a href='#' className='w-10 h-10 rounded-full items-center justify-center hidden lg:flex mr-5 mt-1'><Image src="http://uitheme.net/sociala/images/profile-4.png" width="35" height="35" alt="Friend image"></Image></a>
